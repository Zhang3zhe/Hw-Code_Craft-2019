...
def main():
    #导入数据
    car_data = data_io.data_input_from_file('SDK/SDK/SDK/SDK_python/CodeCraft-2019/config01/car.txt')
    road_data = data_io.data_input_from_file('SDK/SDK/SDK/SDK_python/CodeCraft-2019/config01/road.txt')
    cross_data = data_io.data_input_from_file('SDK/SDK/SDK/SDK_python/CodeCraft-2019/config01/cross.txt')
    #1 初始化相关
    #1.
    #1.2 完成了每条道路各自1 完成了汽车、道路以及路口各自的链表连接拥有的线路连接
    #1.3 完成了路口与相通道路的连接
